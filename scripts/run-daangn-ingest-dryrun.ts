...
(async () => {
  ...
  console.log("searchConcurrency:", result.searchConcurrency);
  ...
  console.log("filteredArticles:", result.filteredArticles);
  console.log("droppedByCategory:", result.articlesDroppedByCategory);
  console.log("missingCategory:", result.articlesMissingCategory);
  console.log("dropRatio:      ", `${(result.categoryFilterDropRatio * 100).toFixed(1)}%`);
  console.log("catalogHintArticles:", result.catalogHintArticles);
  console.log("droppedByCatalogHint:", result.articlesDroppedByCatalogHint);
  console.log("upsertCandidateArticles:", result.upsertCandidateArticles, `/ cap ${result.maxUpsertArticles}`);
  console.log("deferredByUpsertCap:", result.articlesDeferredByUpsertCap);
