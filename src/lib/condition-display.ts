...
const CONDITION_NOTE_CHIP_BY_NOTE: Record<string, string> = {
  ...
  bag_corner_worn: "condition:bag_corner_worn",
  bag_paint_peeling: "condition:bag_leather_damage",
  shoe_stain_or_discoloration: "condition:fashion_stain_or_discoloration",
  shoe_hygiene_warning: "condition:fashion_hygiene_warning",
  shoe_upper_structural_damage: "condition:shoe_upper_damage",
