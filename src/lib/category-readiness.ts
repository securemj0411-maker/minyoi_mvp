...
export const LANE_READINESS: LaneReadinessMap = {
  ...
  stussy_hoodie: { status: "ready", label: "Stüssy Hoodie (pullover)", note: "Wave 805: crewneck/맨투맨 and zip hoodie split out; pullover hoodie only." },
  stussy_crewneck_sweat: { status: "ready", label: "Stüssy Crewneck / Sweatshirt", note: "Wave 805: hoodie lane에서 분리. 후드/집업/Nike collab 차단." },
  stussy_zip_hoodie: { status: "ready", label: "Stüssy Zip Hoodie", note: "Wave 805: pullover hoodie와 가격 축 분리. crewneck/Nike collab 차단." },
  ...
  stussy_nike_shoe_collab: { status: "blocked", label: "Nike × Stüssy Footwear", note: "Wave 803: broad footwear mixes Benassi/Huarache/Air Penny/LD-1000/Air Max/Spiridon (5만~110만). Keep only narrow shoe lanes ready." },
  ...
  cdg_nike_dunk_low_collab: { status: "ready", label: "Nike × CDG Dunk Low", note: "Wave 817 — exact split from blocked CDG Nike broad." },
  cdg_nike_terminator_high_collab: { status: "ready", label: "Nike × CDG Terminator High", note: "Wave 817 — exact split from blocked CDG Nike broad." },
  cdg_nike_pegasus_collab: { status: "ready", label: "Nike × CDG Pegasus", note: "Wave 817 — exact split from blocked CDG Nike broad." },
  cdg_nike_presto_tent_collab: { status: "ready", label: "Nike × CDG Presto Foot Tent", note: "Wave 817 — exact split from blocked CDG Nike broad." },
  cdg_nike_tennis_classic_collab: { status: "ready", label: "Nike × CDG Tennis Classic", note: "Wave 817 — exact split from blocked CDG Nike broad." },
  cdg_nike_sense96_collab: { status: "ready", label: "Nike × CDG Sense 96", note: "Wave 817 — exact split from blocked CDG Nike broad." },
  cdg_nike_foamposite_collab: { status: "ready", label: "Nike × CDG Foamposite", note: "Wave 817 — exact split from blocked CDG Nike broad." },
  cdg_nike_talaria_collab: { status: "ready", label: "Nike × CDG Talaria", note: "Wave 817 — exact split from blocked CDG Nike broad." },
  cdg_nike_heel_premier_collab: { status: "ready", label: "Nike × CDG Heel Premier", note: "Wave 817 — exact split from blocked CDG Nike broad." },
  cdg_nike_collab: { status: "blocked", label: "Nike × CDG Homme Plus (collab)", note: "Wave 814/817 hold: broad collab mixed Dunk/Pegasus/Terminator/Talaria/Foamposite/Tennis Classic/Presto/Sense/Heel Premier. Keep broad internal; release exact model lanes only." },
  ...
  carhartt_converse_collab: { status: "blocked", label: "Converse × Carhartt WIP broad", note: "Wave 806: One Star/Chuck 70/Jack Purcell spread; exact silhouette lanes only." },
  carhartt_converse_one_star: { status: "ready", label: "Converse × Carhartt WIP One Star", note: "Wave 806 — active ready silhouette split." },
  carhartt_converse_chuck70: { status: "ready", label: "Converse × Carhartt WIP Chuck 70", note: "Wave 806 — silhouette split." },
  carhartt_converse_jack_purcell: { status: "ready", label: "Converse × Carhartt WIP Jack Purcell", note: "Wave 806 — silhouette split." },
  ...
  puma_football_broad: {
    status: "blocked",
    label: "Puma Football/Futsal (Ultra/King/Future)",
    note: "Wave 809: sample audit found broad-family public risk across Ultra/King/Future and TF/FG/MG. Keep catalog match for raw learning, but hold public pool until sub-lanes are promoted.",
  },
  puma_football_ultra: { status: "ready", label: "Puma Ultra Football/Futsal", note: "Wave 811: explicit model lane promoted after broad sample cleanup." },
  puma_football_future: { status: "ready", label: "Puma Future Football/Futsal", note: "Wave 811: explicit model lane promoted after Future Cat/Rider/leak blocks." },
  puma_football_king: { status: "ready", label: "Puma King Football/Futsal", note: "Wave 811: explicit phrase lane promoted after marking/tracking substring blocks." },
  ...
  asics_gel_kayano_broad: {
    status: "blocked",
    label: "Asics Gel Kayano broad (14/26/27/31/32)",
    note: "Wave 810: sample audit found generation/collab spread in the broad Kayano bucket. Keep raw learning, hold public pool until exact Kayano lanes are promoted.",
  },
  asics_gel_kayano_14: { status: "ready", label: "Asics Gel-Kayano 14 plain/general", note: "Wave 811: 100+ raw rows, collab/limited variants excluded; exact generation lane promoted." },
  asics_gel_kayano_28: { status: "blocked", label: "Asics Gel-Kayano 28", note: "Wave 811: exact generation captured for learning; keep internal until sample QA." },
  asics_gel_kayano_31: { status: "blocked", label: "Asics Gel-Kayano 31", note: "Wave 811: exact generation captured for learning; keep internal until sample QA." },
  asics_gel_kayano_32: { status: "blocked", label: "Asics Gel-Kayano 32", note: "Wave 811: exact generation captured for learning; keep internal until sample QA." },
  asics_gel_nimbus: { status: "ready", label: "Asics Gel Nimbus", note: "Wave 209; Wave 806 splits Nimbus 9/10.1 exact lanes." },
  asics_gel_nimbus_9: { status: "ready", label: "Asics Gel-Nimbus 9 / UB3-S", note: "Wave 806 — active ready spread split." },
  asics_gel_nimbus_10_1: { status: "ready", label: "Asics Gel-Nimbus 10.1", note: "Wave 806 — explicit 10.1 split." },
  asics_gel_kinetic: { status: "ready", label: "Asics Gel Kinetic", note: "Wave 209" },
  asics_gel_kinetic_sp: { status: "ready", label: "Asics Gel-Kinetic SP", note: "Wave 806 — Quantum/Kinetic high-spread split." },
  ...
  asics_kiko_collab: { status: "blocked", label: "Asics × Kiko Kostadinov broad collab", note: "Wave 806: 5x spread across Gel-Kiril/Sokat/Korika/Lokros; exact sub-lanes only." },
  asics_kiko_gel_kiril: { status: "ready", label: "Asics × Kiko Gel-Kiril", note: "Wave 806 — explicit Kiko model split." },
  asics_kiko_gel_sokat: { status: "ready", label: "Asics × Kiko Gel-Sokat", note: "Wave 806 — explicit Kiko model split." },
  asics_kiko_gel_korika: { status: "ready", label: "Asics × Kiko Gel-Korika", note: "Wave 806 — explicit Kiko model split." },
  asics_kiko_gel_lokros: { status: "ready", label: "Asics × Kiko Gel-Lokros", note: "Wave 806 — explicit Kiko model split." },
  asics_kiko_novalis_gel_teremoa: { status: "ready", label: "Asics Novalis Gel-Teremoa", note: "Wave 806 — explicit Kiko/Novalis model split." },
  asics_kiko_heaven: { status: "ready", label: "Asics × Kiko Heaven", note: "Wave 806 — explicit Kiko model split." },
  ...
  fog_essentials_jacket: { status: "internal_only", label: "FOG Essentials Jacket broad", note: "Wave 830: sample<5 and jacket/anorak/denim/coach/puffer variants require exact split before public release." },
  ...
  gucci_rhyton: { status: "internal_only", label: "Gucci Rhyton Sneaker", note: "Wave 822: public lane paused; live samples mix Dirty/Lip/GG/Square/25/1921/Wave/Mouse/Star variants." },
  nike_tailwind_79: { status: "ready", label: "Nike Tailwind 79 (Vintage Runner)", note: "Wave 227" },
  shoe_converse_chuck70_white: { status: "ready", label: "Converse Chuck 70 White", note: "Wave 863: exact white lane restored; Mission-V/AT-CX/Sketch/Isabel/White Pack variants blocked." },
  shoe_hoka_bondi_7: { status: "ready", label: "Hoka Bondi 7", note: "Wave 863: exact Bondi 7 lane restored from stale null collision with Hoka broad." },
  ...
  adidas_football_broad: {
    status: "blocked",
    label: "Adidas Football (F50/Predator/Copa/X)",
    note: "Wave 809: sample audit found broad-family public risk across F50/Predator/Copa/X and TF/FG/MG. Keep catalog match for raw learning, but hold public pool until explicit sub-lanes are promoted.",
  },
  adidas_football_f50: { status: "ready", label: "Adidas F50 Football/Futsal", note: "Wave 811: explicit F50 lane promoted; limited/signature/accessory rows blocked." },
  adidas_football_predator: { status: "ready", label: "Adidas Predator Football/Futsal", note: "Wave 811: explicit Predator lane promoted; limited/signature/accessory rows blocked." },
  adidas_football_copa: { status: "ready", label: "Adidas Copa Football/Futsal", note: "Wave 811: explicit Copa lane promoted; limited/signature/accessory rows blocked." },
  nike_mercurial_vapor_16_elite_fg: { status: "ready", label: "Nike Mercurial Vapor 16 Elite FG", note: "Wave 819: exact football boot split from blocked Mercurial broad." },
  nike_mercurial_vapor_16_elite_ag: { status: "ready", label: "Nike Mercurial Vapor 16 Elite AG", note: "Wave 819: exact football boot split from blocked Mercurial broad." },
  nike_mercurial_vapor_16_elite_tf: { status: "ready", label: "Nike Mercurial Vapor 16 Elite TF", note: "Wave 819: exact football boot split from blocked Mercurial broad." },
  nike_mercurial_vapor_16_pro_tf: { status: "ready", label: "Nike Mercurial Vapor 16 Pro TF", note: "Wave 819: exact football boot split from blocked Mercurial broad." },
  nike_mercurial_vapor_15_pro_tf: { status: "ready", label: "Nike Mercurial Vapor 15 Pro TF", note: "Wave 819: exact football boot split from blocked Mercurial broad." },
  nike_mercurial_vapor_14_elite_ag: { status: "ready", label: "Nike Mercurial Vapor 14 Elite AG", note: "Wave 819: exact football boot split from blocked Mercurial broad." },
  nike_mercurial_vapor_14_pro_tf: { status: "ready", label: "Nike Mercurial Vapor 14 Pro TF", note: "Wave 819: exact football boot split from blocked Mercurial broad." },
  nike_air_superfly: { status: "internal_only", label: "Nike Air Superfly lifestyle sneaker", note: "Wave 856: split from Mercurial Superfly football broad; hold until sample quality is proven." },
  ...
  bape_tee: { status: "blocked", label: "BAPE T-Shirt (broad)", note: "Wave 812: active sample audit still shows basic/college/milo/camo/ladies/limited tee spread across A/B grades. Keep catalog for learning, but hold public pool until narrower tee lanes are split." },
  ...
  arcteryx_atom_sl: { status: "ready", label: "Arc'teryx Atom SL", note: "Wave 805: Atom SL explicit sub-line split." },
  arcteryx_atom_ar_heavyweight: { status: "ready", label: "Arc'teryx Atom AR / Heavyweight", note: "Wave 805: heavier Atom line separated from LT/SL." },
  arcteryx_beta_lt: { status: "ready", label: "Arc'teryx Beta LT", note: "Wave 805: Beta LT separated from SL/AR." },
  arcteryx_beta_sl: { status: "ready", label: "Arc'teryx Beta SL", note: "Wave 805: Beta SL separated from LT/AR." },
  arcteryx_beta_ar: { status: "ready", label: "Arc'teryx Beta AR", note: "Wave 805: Beta AR separated from SL/LT." },
  ...
  yeezy_boost_350: { status: "internal_only", label: "Yeezy Boost 350 (V1/V2)", note: "Wave 824: legacy broad paused; V1/V2/colorways/order-style rows need exact split." },
  ...
  bape_sta: { status: "internal_only", label: "BAPE STA (Bapesta 신발)", note: "Wave 823: public lane paused; goods/accessory stale rows plus OS/#/collab/custom variants need exact split." },
  ...
  shoe_ugg_classic_broad: { status: "ready", label: "UGG Classic Boot (generic broad)", note: "Wave 806 — explicit Short/Mini/Tall/Ultra Mini/Dipper/Platform/Tasman/Neumel/Disquette split out; broad only for generic classic boot wording." },
  ugg_classic_short: { status: "ready", label: "UGG Classic Short", note: "Wave 806 — laneKey added so Short no longer collides with generic UGG broad." },
  ugg_classic_short_weather_hybrid: { status: "ready", label: "UGG Classic Short Weather Hybrid", note: "Wave 806 — high-price hybrid short boot split from Classic Short/broad." },
  ugg_classic_short_ii: { status: "ready", label: "UGG Classic Short II", note: "Wave 806 — explicit Short 2 split from generic Classic broad." },
  ugg_classic_mini: { status: "ready", label: "UGG Classic Mini", note: "Wave 806 — laneKey added so Mini no longer collides with generic UGG broad." },
  ugg_classic_mini_ii: { status: "ready", label: "UGG Classic Mini II", note: "Wave 806 — Mini 2 explicit model split from broad." },
  ugg_classic_ultra_mini: { status: "ready", label: "UGG Classic Ultra Mini", note: "Wave 806 — Ultra Mini split from Classic Mini/broad." },
  ugg_classic_ultra_mini_platform: { status: "ready", label: "UGG Classic Ultra Mini Platform", note: "Wave 806 — Ultra Mini Platform split from standard Ultra Mini." },
  ugg_classic_ultra_mini_new_heights: { status: "ready", label: "UGG Classic Ultra Mini New Heights", note: "Wave 806 — New Heights heel/platform axis split from standard Ultra Mini." },
  ugg_classic_clear_mini: { status: "ready", label: "UGG Classic Clear Mini", note: "Wave 806 — Clear Mini translucent boot split from standard Mini." },
  ugg_classic_mini_platform: { status: "ready", label: "UGG Classic Mini Platform", note: "Wave 806 — platform/키높이 price axis split from Classic Mini." },
  ugg_classic_mini_dipper: { status: "ready", label: "UGG Classic Mini Dipper", note: "Wave 806 — Dipper/Puffer split from Classic Mini/broad." },
  ugg_classic_tall: { status: "ready", label: "UGG Classic Tall", note: "Wave 806 — laneKey added so Tall no longer collides with generic UGG broad." },
  ugg_tasman: { status: "ready", label: "UGG Tasman", note: "Wave 806 — slipper silhouette split from Classic Boot broad." },
  ugg_neumel: { status: "ready", label: "UGG Neumel", note: "Wave 806 — chukka boot silhouette split from Classic Boot broad." },
  ugg_disquette: { status: "ready", label: "UGG Disquette", note: "Wave 806 — slipper platform silhouette split from Classic Boot broad." },
  // Wave 813: shoe category stays internal-only, but audited exact/high-end lanes must release through lane gates.
  // This fixes ready starvation where exact SKUs were safe but lacked a lane readiness row.
  lv_trainer: { status: "ready", label: "Louis Vuitton LV Trainer", note: "Wave 813 — SKU safety report: exact lane, current-match clean." },
  lv_runaway: { status: "ready", label: "Louis Vuitton Run Away", note: "Wave 813 — exact high-end sneaker lane restored after gate audit." },
  hermes_izmir: { status: "ready", label: "Hermes Izmir", note: "Wave 813 — exact sandal/slipper lane restored after gate audit." },
  dior_b23: { status: "ready", label: "Dior B23", note: "Wave 813 — exact Dior sneaker lane restored after gate audit." },
  dior_b27: { status: "ready", label: "Dior B27", note: "Wave 813 — exact Dior sneaker lane restored after gate audit." },
  dior_b30: { status: "ready", label: "Dior B30", note: "Wave 813 — exact Dior sneaker lane restored after gate audit." },
  shoe_nike_pegasus_turbo: { status: "ready", label: "Nike Pegasus Turbo", note: "Wave 813 — id-based exact shoe lane restored after gate audit." },
  shoe_converse_chuck70_cdg_play_white: { status: "ready", label: "Converse Chuck 70 CDG Play White", note: "Wave 813 — id-based exact shoe lane restored after gate audit." },
  shoe_newbalance_550_white_green: { status: "ready", label: "New Balance 550 White Green", note: "Wave 813 — id-based exact shoe lane restored after gate audit." },
  ...
  newbalance_990v6: { status: "ready", label: "NB 990v6", note: "Wave 860: legacy exact laneKey added to resolve duplicate 990v6 broad ambiguity." },
  ...
  shoe_newbalance_casablanca_collab: { status: "internal_only", label: "NB x Casablanca broad", note: "Wave 828: 327/XC-72 split; model-missing broad held." },
  nb_casablanca_327: { status: "ready", label: "NB x Casablanca 327", note: "Wave 828 — exact 327 split from Casablanca broad." },
  nb_casablanca_xc72: { status: "ready", label: "NB x Casablanca XC-72", note: "Wave 828 — exact XC-72 split from Casablanca broad." },
  ...
  // FOG Main Line 의류
  fog_main_jacket: { status: "blocked", label: "FOG Main Line 자켓 (broad)", note: "Wave 812: sample audit found broad 5th/6th/8th, rider, suede, fur/sherpa/denim/trucker material axes. Hold public pool until sub-lanes are split." },
  ...
  alpha_mil_jacket: { status: "blocked", label: "Alpha Industries MA-1 / N3B 항공자켓", note: "Wave 812: sample audit found MA-1/N2B/M65/leather/stadium spread in one broad lane. Keep catalog for learning, but hold public pool until model/material split." },
  ...
  supreme_collab_broad: { status: "blocked", label: "Supreme Collab Broad (Velvet Underground 등)", note: "Wave 865: 일반 후드/맨투맨/크루넥 및 Nike/Shoe brand-stuffing false positive 확인. 모델별 split 전 public hold." },
  arcteryx_proton: { status: "ready", label: "Arc'teryx Proton (generic)", note: "Wave 805: explicit LT/FL/SV/AR rows split into sub-line lanes." },
  arcteryx_proton_lt: { status: "ready", label: "Arc'teryx Proton LT", note: "Wave 805: Proton LT explicit sub-line split." },
  arcteryx_proton_fl: { status: "ready", label: "Arc'teryx Proton FL", note: "Wave 805: Proton FL explicit sub-line split." },
  arcteryx_proton_sv: { status: "ready", label: "Arc'teryx Proton SV", note: "Wave 805: Proton SV explicit sub-line split." },
  arcteryx_proton_ar: { status: "ready", label: "Arc'teryx Proton AR", note: "Wave 805: Proton AR explicit sub-line split." },
  ...
  carhartt_denim_pants: { status: "ready", label: "Carhartt Denim / Newel Pants", note: "Wave 729 — 9+건/주 p50 9.1만. Wave 868: Landon exact lane과 충돌 방지 위해 Landon token 제외." },
  carhartt_landon_pants: { status: "blocked", label: "Carhartt WIP Landon Pants", note: "Wave 868: denim broad와 분리했지만 sample 적어 public hold." },
  ...
  lacoste_apparel_broad: { status: "internal_only", label: "Lacoste Apparel Broad", note: "Wave 829: broad clothing held; pique polo narrowed, exact Lacoste garment lanes needed before public release." },
  ...
  thugclub_teamgeist_hoodie: { status: "ready", label: "Thug Club × Adidas Team Geist Hoodie", note: "Wave 716 — 120x adidas_thugclub_collab spread 해소 (63만 tier)." },
  thugclub_teamgeist_leather_jacket: { status: "blocked", label: "Thug Club × Adidas Team Geist Leather Jacket", note: "Wave 868: 후디와 레더 자켓 상품 타입/시세축 분리. sample 검증 전 public hold." },
  ...
  stussy_nike_air_penny: { status: "ready", label: "Stussy × Nike Air Penny 2", note: "Wave 805: broad Stussy Nike footwear blocked; Air Penny explicit lane only." },
  // NB collab
  ...
  mizuno_wave_prophecy: { status: "blocked", label: "Mizuno Wave Prophecy broad", note: "Wave 806: MOC/Beta/LS/collab spread; exact sub-lanes only." },
  mizuno_wave_prophecy_moc: { status: "ready", label: "Mizuno Wave Prophecy MOC", note: "Wave 806 — active ready MOC split." },
  mizuno_wave_prophecy_beta: { status: "ready", label: "Mizuno Wave Prophecy Beta", note: "Wave 806 — explicit sub-line split." },
  mizuno_wave_prophecy_ls: { status: "ready", label: "Mizuno Wave Prophecy LS", note: "Wave 806 — explicit sub-line split." },
  mizuno_wave_prophecy_graphpaper: { status: "ready", label: "Mizuno × Graphpaper Wave Prophecy", note: "Wave 806 — collab split." },
  mizuno_wave_prophecy_blankof: { status: "ready", label: "Mizuno × Blankof Wave Prophecy", note: "Wave 806 — collab split." },
  ...
  puma_nitro_running: { status: "blocked", label: "Puma Nitro broad running family", note: "Wave 806: Deviate/Velocity/Elite spread; explicit model lanes only." },
  puma_deviate_nitro: { status: "ready", label: "Puma Deviate Nitro", note: "Wave 806 — Nitro family split." },
  puma_deviate_nitro_elite: { status: "ready", label: "Puma Deviate Nitro Elite", note: "Wave 806 — Nitro family split." },
  puma_velocity_nitro: { status: "ready", label: "Puma Velocity Nitro", note: "Wave 806 — Nitro family split." },
  ...
  // Asics 추가
  asics_gel_quantum: { status: "blocked", label: "Asics Gel-Quantum broad", note: "Wave 806: 360/90/Kinetic SP/collab spread; exact sub-lanes only." },
  asics_gel_quantum_360: { status: "ready", label: "Asics Gel-Quantum 360", note: "Wave 806 — active ready broad split." },
  asics_gel_quantum_90: { status: "ready", label: "Asics Gel-Quantum 90", note: "Wave 806 — explicit generation split." },
  asics_gel_quantum_cp_company: { status: "ready", label: "Asics × C.P. Company Gel-Quantum", note: "Wave 806 — premium collab split." },
  ...
  drmartens_1460_black: { status: "ready", label: "Dr. Martens 1460 Black", note: "Wave 857: legacy exact color lane restored with laneKey; variants blocked." },
  ...
  // Yeezy broad
  yeezy_350_broad: { status: "internal_only", label: "Yeezy Boost 350 V2 broad", note: "Wave 824: broad paused; colorway spread and dropship/order rows require exact split." },
  ...
  hoka_satisfy_clifton_ls: { status: "internal_only", label: "Hoka × Satisfy Clifton LS", note: "Wave 827: split from Mafate/Satisfy; sample-backed but held until clean public market depth." },
...
export function evaluateLaneReadinessForSku(
  ...
  const candidateKeys = [sku?.laneKey, fallbackKey].filter((key): key is string => Boolean(key));
  const laneKey = candidateKeys.find((key) => laneMap[key]);
