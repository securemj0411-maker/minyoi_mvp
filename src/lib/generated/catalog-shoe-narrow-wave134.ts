...
const UGG_OTHER_BRAND_BLOCK = [
  "오즈웨어", "오즈 어그", "오즈어그", "오즈어그웨어", "ozwear", "oz wear", "oz ugg", "ozugg", "oz어그",
];
...
export const SHOE_NARROW_CATALOG: Sku[] = [
  ...
  // ─── 어그 (모델 분리) ────────────────────────────────────
  {
    ...
    brand: "UGG",
    category: "shoe",
    laneKey: "ugg_classic_short",
    modelName: "UGG Classic Short",
    aliases: ["어그 클래식 숏", "UGG Classic Short", "어그 숏"],
    mustContain: [
      ["어그", "ugg"],
      ["클래식 숏", "classic short", "숏 부츠", "short boot", "클래식숏", "클래식 부츠 숏", "classic boot short"],
    ],
    mustNotContain: [
  ...
  {
    id: "shoe-ugg-classic-short-weather-hybrid",
    brand: "UGG",
    category: "shoe",
    laneKey: "ugg_classic_short_weather_hybrid",
    modelName: "UGG Classic Short Weather Hybrid",
    aliases: ["어그 클래식 숏 웨더 하이브리드", "UGG Classic Short Weather Hybrid"],
    mustContain: [
      ["어그", "ugg"],
      ["클래식 숏", "classic short", "숏", "short", "쇼트"],
      ["웨더 하이브리드", "웨더하이브리드", "weather hybrid", "웨어 하이브리드", "웨어하이브리드", "하이브리드", "hybrid"],
    ],
    mustNotContain: [
      "미니", "mini", "울트라", "ultra", "톨", "tall", "탈",
      ...UGG_OTHER_BRAND_BLOCK,
      ...COMMON_BLOCK,
      ...COLLAB_BLOCK,
    ],
  ...
  {
    id: "shoe-ugg-classic-short-ii",
    brand: "UGG",
    category: "shoe",
    laneKey: "ugg_classic_short_ii",
    modelName: "UGG Classic Short II",
    aliases: ["어그 클래식 숏 2", "UGG Classic Short II", "어그 클래식 쇼트 2"],
    mustContain: [
      ["어그", "ugg"],
      ["클래식 숏 2", "클래식 숏2", "클래식 숏 ii", "클래식 쇼트 2", "클래식 쇼트2", "클래식 쇼트 ii", "classic short ii", "classic short 2", "숏 2", "숏2", "숏 ii", "쇼트 2", "쇼트2", "쇼트 ii", "short ii", "short 2"],
    ],
    mustNotContain: [
      "미니", "mini", "울트라", "ultra", "톨", "tall", "탈",
      "웨더 하이브리드", "웨더하이브리드", "weather hybrid", "웨어 하이브리드", "웨어하이브리드", "하이브리드", "hybrid",
  ...
  {
    id: "shoe-ugg-classic-mini-ii",
    brand: "UGG",
    category: "shoe",
    laneKey: "ugg_classic_mini_ii",
    modelName: "UGG Classic Mini II",
    aliases: ["어그 클래식 미니 2", "어그 클래식 미니2", "UGG Classic Mini II"],
    mustContain: [
      ["어그", "ugg"],
      ["클래식 미니 2", "클래식 미니2", "클래식 미니 ii", "classic mini ii", "classic mini 2", "미니 2", "미니2", "미니 ii", "mini ii", "mini 2"],
    ],
    mustNotContain: [
      "울트라 미니", "ultra mini", "울트라미니",
      "플랫폼", "platform",
      "디퍼", "dipper", "디스켓", "disquette",
      "숏", "short", "톨", "tall", "탈",
      ...UGG_OTHER_BRAND_BLOCK,
      ...COMMON_BLOCK,
      ...COLLAB_BLOCK,
  ...
  {
    id: "shoe-ugg-classic-ultra-mini",
    brand: "UGG",
    category: "shoe",
    laneKey: "ugg_classic_ultra_mini",
    modelName: "UGG Classic Ultra Mini",
    aliases: ["어그 클래식 울트라 미니", "UGG Classic Ultra Mini", "어그 울트라미니"],
    mustContain: [
      ["어그", "ugg"],
      ["울트라 미니", "ultra mini", "울트라미니"],
    ],
    mustNotContain: [
      "플랫폼", "platform",
      "디퍼", "dipper", "디스켓", "disquette",
      "뉴 하이츠", "뉴하이츠", "new heights", "newheights",
      "뉴 하이", "뉴하이", "new high", "newhigh",
      "클리어 미니", "clear mini",
      ...UGG_OTHER_BRAND_BLOCK,
      ...COMMON_BLOCK,
      ...COLLAB_BLOCK,
  ...
  {
    id: "shoe-ugg-classic-ultra-mini-platform",
    brand: "UGG",
    category: "shoe",
    laneKey: "ugg_classic_ultra_mini_platform",
    modelName: "UGG Classic Ultra Mini Platform",
    aliases: ["어그 클래식 울트라 미니 플랫폼", "UGG Classic Ultra Mini Platform", "어그 울트라미니 플랫폼"],
    mustContain: [
      ["어그", "ugg"],
      ["울트라 미니", "ultra mini", "울트라미니"],
      ["플랫폼", "platform", "키높이"],
  ...
  {
    id: "shoe-ugg-classic-ultra-mini-new-heights",
    brand: "UGG",
    category: "shoe",
    laneKey: "ugg_classic_ultra_mini_new_heights",
    modelName: "UGG Classic Ultra Mini New Heights",
    aliases: ["어그 클래식 울트라 미니 뉴 하이츠", "UGG Classic Ultra Mini New Heights"],
    mustContain: [
      ["어그", "ugg"],
      ["울트라 미니", "ultra mini", "울트라미니"],
      ["뉴 하이츠", "뉴하이츠", "new heights", "newheights", "뉴 하이", "뉴하이", "new high", "newhigh"],
    ],
    mustNotContain: [
      "디퍼", "dipper", "디스켓", "disquette",
      "클리어 미니", "clear mini",
  ...
  {
    id: "shoe-ugg-classic-clear-mini",
    brand: "UGG",
    category: "shoe",
    laneKey: "ugg_classic_clear_mini",
    modelName: "UGG Classic Clear Mini",
    aliases: ["어그 클래식 클리어 미니", "UGG Classic Clear Mini"],
    mustContain: [
      ["어그", "ugg"],
      ["클리어 미니", "clear mini"],
    ],
    mustNotContain: [
      "울트라", "ultra", "플랫폼", "platform", "디퍼", "dipper", "디스켓", "disquette",
      ...UGG_OTHER_BRAND_BLOCK,
      ...COMMON_BLOCK,
      ...COLLAB_BLOCK,
    ],
  ...
  {
    id: "shoe-ugg-classic-mini-platform",
    brand: "UGG",
    category: "shoe",
    laneKey: "ugg_classic_mini_platform",
    modelName: "UGG Classic Mini Platform",
    aliases: ["어그 클래식 미니 플랫폼", "UGG Classic Mini Platform", "어그 플랫폼 미니"],
    mustContain: [
      ["어그", "ugg"],
      ["미니", "mini"],
      ["플랫폼", "platform", "키높이"],
    ...
    mustNotContain: [
      "울트라 미니", "ultra mini", "울트라미니",
      "디퍼", "dipper", "디스켓", "disquette",
      "펠티드", "felted", "맥시", "maxi", "코듀로이", "corduroy", "쉬어링", "shearling",
      ...UGG_OTHER_BRAND_BLOCK,
      ...COMMON_BLOCK,
      ...COLLAB_BLOCK,
    ],
  ...
  {
    id: "shoe-ugg-classic-mini-dipper",
    brand: "UGG",
    category: "shoe",
    laneKey: "ugg_classic_mini_dipper",
    modelName: "UGG Classic Mini Dipper",
    aliases: ["어그 클래식 미니 디퍼", "UGG Classic Mini Dipper", "어그 디퍼"],
    mustContain: [
      ["어그", "ugg"],
      ["디퍼", "dipper"],
    ],
  ...
  },
  {
    ...
    brand: "UGG",
    category: "shoe",
    laneKey: "ugg_classic_tall",
    modelName: "UGG Classic Tall",
    aliases: ["어그 클래식 탈", "UGG Classic Tall", "어그 탈"],
    mustContain: [
      ["어그", "ugg"],
      ["클래식 톨", "클래식톨", "톨 부츠", "톨", "클래식 탈", "classic tall", "탈 부츠", "tall boot", "클래식탈"],
    ],
    mustNotContain: [
      "미니", "mini", "숏", "short", "얼티멋",
      ...UGG_OTHER_BRAND_BLOCK,
  ...
  },
  {
    ...
    category: "shoe",
    laneKey: "ugg_tasman",
    modelName: "UGG Tasman",
    aliases: ["어그 타스만", "UGG Tasman"],
    mustContain: [
      ["어그", "ugg"],
      ["타스만", "tasman"],
    ],
    mustNotContain: [
      "플랫폼", "platform", "키즈", "kids", "레인부츠", "레인 부츠", "rain boot", "rainboot",
      ...UGG_OTHER_BRAND_BLOCK,
      ...COMMON_BLOCK,
      ...COLLAB_BLOCK,
    ],
  ...
  },
  {
    ...
    category: "shoe",
    laneKey: "ugg_neumel",
    modelName: "UGG Neumel",
    aliases: ["어그 뉴멜", "UGG Neumel"],
    mustContain: [
      ["어그", "ugg"],
      ["뉴멜", "뉴멀", "neumel"],
    ],
    mustNotContain: [
      "플랫폼", "platform", "키즈", "kids",
      ...UGG_OTHER_BRAND_BLOCK,
      ...COMMON_BLOCK,
      ...COLLAB_BLOCK,
    ],
  ...
  {
    id: "shoe-ugg-disquette",
    brand: "UGG",
    category: "shoe",
    laneKey: "ugg_disquette",
    modelName: "UGG Disquette",
    aliases: ["어그 디스켓", "UGG Disquette"],
    mustContain: [
      ["어그", "ugg"],
      ["디스켓", "disquette"],
    ],
  ...
  },
  {
    ...
    mustNotContain: [
      "990v5", "v5", "990v4",
      "991", "992", "993", "997", "998",
      "joe freshgoods", "ald", "aime leon dore", "action bronson", "액션 브론슨",
      ...COMMON_BLOCK,
      ...COLLAB_BLOCK,
    ],
    msrpKrw: 289000,
  ...
  // Noise: "어그로 아님" (자전거 매물), 가방/파우치, 패딩
  {
    ...
    brand: "UGG",
    category: "shoe",
    laneKey: "shoe_ugg_classic_broad",
    modelName: "UGG Classic Boot (generic broad)",
    aliases: ["UGG Classic", "어그 클래식", "어그 미니", "어그 부츠"],
    mustContain: [
      ["ugg", "어그"],
      ["클래식", "classic", "부츠", "boot", "미니", "mini", "숏", "short", "톨", "tall"],
    ],
    mustNotContain: [
      // Wave 806: explicit UGG silhouettes have their own lanes. Broad is only
      // for generic "UGG Classic/boot" rows without a model axis.
      "클래식 미니", "classic mini", "어그 미니", "ugg mini", "미니", "mini",
      "클래식 숏", "classic short", "숏 부츠", "short boot", "숏", "short", "쇼트",
      "클래식 톨", "classic tall", "톨 부츠", "tall boot", "톨", "tall", "탈",
      "울트라 미니", "ultra mini", "울트라미니",
      "미니 2", "미니2", "mini ii", "mini 2",
      "플랫폼", "platform", "키높이",
      "디퍼", "dipper", "디스켓", "disquette",
      "타스만", "tasman", "뉴멜", "뉴멀", "neumel",
      "첼시", "chelsea", "레인부츠", "레인 부츠", "rain boot", "rainboot",
      "웨더 하이브리드", "웨더하이브리드", "weather hybrid", "웨어 하이브리드", "웨어하이브리드", "하이브리드", "hybrid",
      // Other-brand/generic sheepskin boot leakage.
      ...UGG_OTHER_BRAND_BLOCK,
      "밍크퍼", "밍크", "mink", "하트", "heart",
      // 짝퉁
      "uggs", "짝퉁", "카피", "이미테이션",
  ...
  // ─── Adidas Samba broad (596 매물/주, collab 별도) ──────
  {
    ...
    mustNotContain: [
      ...
      "gucci", "구찌", "prada", "프라다",
      "한정판", "limited edition",
      // Wave 857: observed non-plain Samba silhouettes/variants.
      "삼바로즈", "sambarose", "samba rose", "비건", "vegan",
      // 키즈
      "키즈", "kids", "유아", "아동", "여아", "남아", "infant", "td",
      // 가품
  ...
  // 이미 narrow에서 한정/SP 다 차단 → broad는 일반 colorway 다 흡수.
  {
    ...
    mustNotContain: [
      ...
      "chunky dunky", "청키 덩키",
      // Wave 821: latest broad sample audit — non-general Dunk axes.
      "골프", "골프화", "golf",
      "트위스트", "twist",
      "sb ", "에스비", "sb x", "sb덩크", "sb 덩크", "프로 덩크",
      "파워퍼프", "powerpuff", "넥페이스", "neckface",
      "쿼터스낵", "쿼터스낵스", "quartersnacks", "quarter snacks",
      "아트모스", "atmos",
      "도언베커", "doernbecher",
      "해리스", "harris", "트위드", "tweed",
      "고어텍스", "goretex", "gore-tex", "gore tex",
      "nba", "바나나", "banana",
      "sp", "qs", "프리미엄", "premium", "넥스트 네이쳐", "next nature",
...

  {
    ...
    mustContain: [
      ["덩크 로우", "덩크로우", "dunk low"],
      ["트래비스", "travis", "travis scott", "트래비스스캇", "트레비스", "스캇", "scott", "cactus jack", "트스"],
    ],
    mustNotContain: ["키즈", "kids", "td", "gs",
      "조던", "jordan", "에어맥스", "에어포스", "force",
      "베이프", "bape", "베이프스타", "apestation", "indigo studio", "skull sta",
      "시카고", "chicago", "골든 갤스", "golden gals", "메탈릭 실버", "metallic silver",
      "짝퉁", "카피", "이미테이션", "rep ", "replica", "fake", "11급", "ss급정품", "1:1", "미러",
      "한짝", "한쪽만", "박스만", "삽니다", "구합니다", "매입"],
...

  {
    ...
    mustNotContain: ["sb ", "에스비", "레이서 블루", "racer blue",
      "짐레드", "짐 레드", "gym red",
...

  {
    ...
    mustNotContain: ["sb ", "에스비", "코스트", "coast", "레이서 블루", "racer blue",
      "키즈", "kids", "td", "gs",
      "짝퉁", "rep ", "replica", "fake", "11급", "ss급정품",
      "한짝", "한쪽만", "박스만", "삽니다", "구합니다", "매입"],
    msrpKrw: 119000, released: 2021,
...

  {
    ...
    mustNotContain: ["키즈", "kids", "td", "gs", "유아", "아동",
      ...
      "키스", "kith", "junya", "준야", "staud", "스태우드", "sabotage", "사보타지",
      "nike", "나이키", "데이브레이크", "daybreak",
      "짝퉁", "rep ", "replica", "fake", "11급", "ss급정품", "1:1",
      "한짝", "한쪽만", "박스만", "남아", "여아", "남아여아", "삽니다", "구합니다", "매입"],
...

  {
    ...
    mustNotContain: ["키즈", "kids", "td", "gs", "유아", "아동",
      ...
      "짝퉁", "rep ", "replica", "fake", "11급", "1:1",
      "한짝", "한쪽만", "박스만", "삽니다", "구합니다", "매입"],
    msrpKrw: 99000, released: 2020, defaultProductType: "boot",
  },
...

  {
    ...
    mustContain: [["뉴발란스", "뉴발", "new balance", "newbalance", "nb"], ["1500", "m1500", "u1500"]],
    mustNotContain: ["키즈", "kids", "td", "gs",
      "짝퉁", "rep ", "replica", "fake", "11급",
      "한짝", "한쪽만", "박스만", "삽니다", "구합니다", "매입"],
...

  {
    ...
    mustNotContain: ["키즈", "kids", "td", "gs",
      "짝퉁", "rep ", "replica", "fake", "11급", "1:1",
      "한짝", "한쪽만", "박스만", "삽니다", "구합니다", "매입",
      "조프레쉬굿즈", "조 프레쉬굿즈", "조프레시굿즈", "조 프레시굿즈",
      "joe freshgoods", "joefreshgoods", "jfg",
      "에임레온도르", "에임 레온도르", "aime leon dore", "aimeleondore", "ald"],
  ...
  {
    id: "shoe-newbalance-casablanca-327-collab",
    brand: "NB x Casablanca", category: "shoe", laneKey: "nb_casablanca_327",
    modelName: "NB x Casablanca 327",
    aliases: ["NB Casablanca 327", "뉴발란스 카사블랑카 327"],
    mustContain: [
      ["뉴발란스", "뉴발", "new balance", "newbalance", "nb"],
      ["카사블랑카", "casablanca"],
      ["327"],
  ...
  {
    id: "shoe-newbalance-casablanca-xc72-collab",
    brand: "NB x Casablanca", category: "shoe", laneKey: "nb_casablanca_xc72",
    modelName: "NB x Casablanca XC-72",
    aliases: ["NB Casablanca XC-72", "뉴발란스 카사블랑카 XC72"],
    mustContain: [
      ["뉴발란스", "뉴발", "new balance", "newbalance", "nb"],
      ["카사블랑카", "casablanca"],
      ["xc-72", "xc72", "uxc72"],
    ...
    mustNotContain: ["키즈", "kids", "td", "gs",
      ...
      "짝퉁", "rep ", "replica", "fake", "11급",
      "한짝", "한쪽만", "박스만", "삽니다", "구합니다", "매입"],
    msrpKrw: 190000, released: 2021, defaultProductType: "sneaker",
  },

  {
    id: "shoe-newbalance-casablanca-collab",
    brand: "NB x Casablanca", category: "shoe",
    modelName: "NB x Casablanca Collab broad (model missing)",
...

  {
    ...
    mustNotContain: ["키즈", "kids", "td", "gs",
      ...
      "dime", "다임",
      "emmi",
      "wood wood", "우드우드", "우드 우드",
      "gallery dept", "gallery department", "갤러리디파트먼트", "갤러리 디파트먼트",
      "짝퉁", "rep ", "replica", "fake", "11급",
      "한짝", "한쪽만", "박스만", "삽니다", "구합니다", "매입"],
    msrpKrw: 159000, released: 2024, defaultProductType: "sneaker",
  },

  {
    ...
    mustNotContain: ["키즈", "kids", "td", "gs",
      "싱글렛", "singlet", "하프타이즈", "타이즈", "tights", "half tights",
      "셔츠", "shirt", "티셔츠", "반팔", "나시", "웨어", "의류", "apparel", "top",
      "스파이크", "spike", "중거리", "육상", "track and field",
      "짝퉁", "rep ", "replica", "fake", "11급",
      "한짝", "한쪽만", "박스만", "삽니다", "구합니다", "매입"],
...

  {
    ...
    brand: "Nike x Travis Scott", category: "shoe",
    laneKey: "shoe_travis_nike_airmax_1",
