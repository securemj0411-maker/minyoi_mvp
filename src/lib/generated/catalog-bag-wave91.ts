...
export const BAG_CATALOG: Sku[] = [
  ...
  },
  {
    ...
    mustContain: [
      ...
      ["5ac", "5ac백", "5ac가방", "5ac크로스", "5ac크로스백", "5ac미니", "5ac마이크로", "5ac스몰"],
    ],
    mustNotContain: [
  ...
  },
  {
    ...
    mustNotContain: [
      ...
      // Wave 550 (2026-05-22): 한정판/콜라보 outlier 차단 (288만~85만 vs 일반 30~50만 +5배).
      "악어지갑 카드지갑 오거나이저", "악어 + 카드", "세트 정품",  // multi-item bundle 288만
      "한정판", "리미티드", "limited",
      "니고", "nigo",  // LV x Nigo 콜라보
