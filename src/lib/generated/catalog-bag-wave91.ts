// Wave 91 (2026-05-15): bags catalog SKUs — body-only, resale ≤200만.
// 출처: agent research /tmp/wave91-bags-research.json.
...
export const BAG_CATALOG: Sku[] = [
  {
    ...
    mustNotContain: [
      "메티스", "metis", "키 포셰트", "key pouch", "키파우치", "키 파우치", "felicie", "펠리시",
    ],
    msrpKrw: 1200000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      "mm", "gm", "다미에", "damier", "이너백만", "이너백 단품", "인너백만", "파우치만",
    ],
    msrpKrw: 2790000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      "30", "35", "40", "반둘리에", "bandouliere", "나노", "nano", "다미에", "damier", "에삐", "epi", "앙프렝뜨", "empreinte",
    ],
    msrpKrw: 2200000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      "pm", "mm", "gm", "에삐", "epi", "베르니", "vernis", "다미에", "damier", "앙프렝뜨", "empreinte",
    ],
    msrpKrw: 2590000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      "미니", "mini", "이스트웨스트", "east west", "리버스", "reverse", "앙프렝뜨", "empreinte",
    ],
    msrpKrw: 3100000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      "에밀리", "emilie", "조시", "josephine", "조세핀", "다미에", "damier", "앙프렝뜨", "empreinte", "에삐", "epi",
    ],
    msrpKrw: 1150000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      "코인", "coin", "콤팩트", "compact", "다미에", "damier", "그래피티", "graffiti",
    ],
    msrpKrw: 1230000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      "스몰", "small", "미디움", "medium", "라지", "large", "벨트백", "belt bag", "카메라백", "camera", "탑핸들", "top handle", "백팩",
    ],
    msrpKrw: 2150000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      "미디움", "medium", "라지", "large", "탑핸들", "top handle", "벨트백",
    ],
    msrpKrw: 1990000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      "여행용", "여권", "passport", "장지갑", "long wallet", "지피", "체인 월릿", "chain wallet",
    ],
    msrpKrw: 580000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      "스몰", "small", "미디움", "medium", "라지", "large", "체인 월릿", "chain wallet",
    ],
    msrpKrw: 2350000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      "스몰", "small", "미디움", "medium", "라지", "large", "마이크로", "micro", "재투입", "재출시", "re-edition",
    ],
    msrpKrw: 3400000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      "미니", "스몰 트리오", "small trio", "트리옴프", "triomphe", "트리오페", "팔로우",
    ],
    msrpKrw: 950000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      "네오 클래식", "neo classic", "북", "book", "아워글래스", "hourglass", "벨로", "velo", "그라피티", "데이",
    ],
    msrpKrw: 3200000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      "장지갑", "long wallet", "지피", "체인 월릿", "chain wallet",
    ],
    msrpKrw: 530000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      "메티스", "metis", "액세서리만", "이너 파우치만", "이너파우치만",
    ],
    msrpKrw: 2050000,
    released: 2024,
