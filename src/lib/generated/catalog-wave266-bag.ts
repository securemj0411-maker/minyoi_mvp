...
const BAG_NON_BAG_NOISE = [
  ...
  "이너백만", "이너백 단품",
  "가방박스 판매", "박스 상자",
  // Wave 603 (2026-05-22): 다중 가방 묶음 매물 차단 (10M outlier 발견).
  //   production: pid 371937927 '샤넬 정품가방 3개랑 생로랑1개' 10M가 ysl_broad 매칭.
  //   주의: '선착순'/'현재가로' 단독은 단일 매물 광고에도 흔함 — 제외.
  "가방 2개", "가방 3개", "가방 4개", "가방 5개", "가방2개", "가방3개", "가방4개", "가방5개",
  "백 2개", "백 3개", "백 4개", "백 5개", "백2개", "백3개", "백4개", "백5개",
  "묶음 판매", "묶음판매", "세트 판매", "세트판매", "일괄 판매", "일괄판매",
  "1개랑", "2개랑", "3개랑",
  // 의류
...
export const BAG_WAVE266_CATALOG: Sku[] = [
  ...
  },
  {
    ...
    mustNotContain: [
      ...
      "패키지", "박스만", "더스트백만",
      // Wave 551 (2026-05-22): 다른 샤넬 모델 catch 차단 (코코비치 1190만/타임리스 클래식 580만).
      "코코비치", "coco beach", "깜봉", "cambon",
      "타임리스 클래식", "timeless classic",
      "데님 쇼핑백",  // 데님 시리즈 별도 (1080~1190만)
    ],
    msrpKrw: 9000000,
    released: 2024,
  ...
  },
  {
    ...
    mustNotContain: [
      ...
      "립", "립글로스",
      "신발", "스니커즈", "벨트",
      // Wave 552 (2026-05-22): 더스트백 (가방 보관용 천) / 박스 / 패키지 등 비가방 액세서리 차단.
      "더스트백", "dust bag", "dustbag",
      "박스", "박스 단품", "박스만",
      "패키지", "package",
    ],
    msrpKrw: 9900000,
