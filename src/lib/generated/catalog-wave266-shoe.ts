...
export const SHOE_WAVE266_CATALOG: Sku[] = [
  ...
  },
  {
    ...
    mustNotContain: [
      ...
      "broken arm", "brokenarm", "브로큰암", "the broken arm",
      "beams", "빔즈",
      "ltr", "leather", "가죽", "코르크", "cork", "moc",
    ],
    msrpKrw: 159000,
    released: 2020,
  ...
  },
  {
    ...
    mustContain: [
      ["뉴발란스 1500", "뉴발 1500", "nb 1500", "nb1500", "new balance 1500", "m1500", "u1500"],
    ],
    mustNotContain: [
      ...SHOE_COMMON_NOISE,
      // 콜라보
  ...
  },
  {
    ...
    mustNotContain: [
      ...
      "메탈릭 헤마타이트", "메탈릭 실버", "메탈릭실버", "metallic hematite", "metallic silver",
    ],
    msrpKrw: 159000,
    released: 2003,
    defaultProductType: "sneaker",
  ...
  },
  {
    ...
    mustNotContain: [
      ...SHOE_COMMON_NOISE,
      // 콜라보 (Stussy/Undefeated/Fragment 가격 축 분리)
      "stussy", "스투시",
  ...
  {
    id: "shoe-nike-air-superfly",
    brand: "Nike",
    category: "shoe",
    laneKey: "nike_air_superfly",
    modelName: "Nike Air Superfly (lifestyle sneaker)",
    aliases: ["Nike Air Superfly", "나이키 에어 슈퍼플라이"],
    mustContain: [
      ["nike", "나이키"],
      ["air superfly", "에어 superfly", "에어 슈퍼플라이", "에어슈퍼플라이"],
    ],
    mustNotContain: [
      ...SHOE_COMMON_NOISE,
      "mercurial", "머큐리얼", "축구화", "풋살화", "football boot", "football shoes",
      "fg", "ag", "mg", "hg", "tf", "엘리트", "elite", "프로", "pro",
    ],
    msrpKrw: 159000,
    released: 2025,
    defaultProductType: "sneaker",
  },
  {
    ...
    mustNotContain: [
      ...
      // Wave 856: lifestyle Nike Air Superfly is not Mercurial football.
      "air superfly", "에어 superfly", "에어 슈퍼플라이", "에어슈퍼플라이",
    ],
    msrpKrw: 339000,
    released: 1998,
  ...
  {
    id: "shoe-nike-mercurial-vapor-16-elite-fg",
    brand: "Nike",
    category: "shoe",
    laneKey: "nike_mercurial_vapor_16_elite_fg",
    modelName: "Nike Mercurial Vapor 16 Elite FG",
    aliases: ["Mercurial Vapor 16 Elite FG", "머큐리얼 베이퍼 16 엘리트 FG"],
    mustContain: [
      ["nike", "나이키"],
      ["mercurial", "머큐리얼"],
      ["vapor", "베이퍼"],
    ...
    mustNotContain: [
      ...SHOE_COMMON_NOISE,
      "superfly", "슈퍼플라이", "수퍼플라이",
      "ag", "tf", "풋살화", "ctr360", "마에스트리",
      "patta", "x 파타", "파타 머큐리얼",
      "prism", "프리즘", "음바페", "mbappe", "km", "누우보", "nuovo",
    ],
    msrpKrw: 329000,
    released: 2024,
    defaultProductType: "sneaker",
  ...
  {
    id: "shoe-nike-mercurial-vapor-16-elite-ag",
    brand: "Nike",
    category: "shoe",
    laneKey: "nike_mercurial_vapor_16_elite_ag",
    modelName: "Nike Mercurial Vapor 16 Elite AG",
    aliases: ["Mercurial Vapor 16 Elite AG", "머큐리얼 베이퍼 16 엘리트 AG"],
    mustContain: [
      ["nike", "나이키"],
      ["mercurial", "머큐리얼"],
      ["vapor", "베이퍼"],
    ...
    mustNotContain: [
      ...SHOE_COMMON_NOISE,
      "superfly", "슈퍼플라이", "수퍼플라이",
      "fg", "tf", "풋살화", "ctr360", "마에스트리", "누우보", "nuovo",
    ],
    msrpKrw: 329000,
    released: 2024,
    defaultProductType: "sneaker",
  ...
  {
    id: "shoe-nike-mercurial-vapor-16-elite-tf",
    brand: "Nike",
    category: "shoe",
    laneKey: "nike_mercurial_vapor_16_elite_tf",
    modelName: "Nike Mercurial Vapor 16 Elite TF",
    aliases: ["Mercurial Vapor 16 Elite TF", "머큐리얼 베이퍼 16 엘리트 TF"],
    mustContain: [
      ["nike", "나이키"],
      ["mercurial", "머큐리얼"],
      ["vapor", "베이퍼"],
      ["16", "xvi"],
      ["elite", "엘리트"],
      ["tf", "풋살화", "엘리트tf", "elitetf"],
    ],
    mustNotContain: [
      ...SHOE_COMMON_NOISE,
      "superfly", "슈퍼플라이", "수퍼플라이",
      "fg", "ag", "ctr360", "마에스트리", "누우보", "nuovo",
    ],
    msrpKrw: 219000,
    released: 2024,
    defaultProductType: "sneaker",
  ...
  {
    id: "shoe-nike-mercurial-vapor-16-pro-tf",
    brand: "Nike",
    category: "shoe",
    laneKey: "nike_mercurial_vapor_16_pro_tf",
    modelName: "Nike Mercurial Vapor 16 Pro TF",
    aliases: ["Mercurial Vapor 16 Pro TF", "머큐리얼 베이퍼 16 프로 TF"],
    mustContain: [
      ["nike", "나이키"],
      ["mercurial", "머큐리얼"],
      ["vapor", "베이퍼"],
    ...
    mustNotContain: [
      ...SHOE_COMMON_NOISE,
      "superfly", "슈퍼플라이", "수퍼플라이",
      "elite", "엘리트", "fg", "ag", "ctr360", "마에스트리", "누우보", "nuovo",
    ],
    msrpKrw: 189000,
    released: 2024,
    defaultProductType: "sneaker",
  ...
  {
    id: "shoe-nike-mercurial-vapor-15-pro-tf",
    brand: "Nike",
    category: "shoe",
    laneKey: "nike_mercurial_vapor_15_pro_tf",
    modelName: "Nike Mercurial Vapor 15 Pro TF",
    aliases: ["Mercurial Vapor 15 Pro TF", "머큐리얼 베이퍼 15 프로 TF"],
    mustContain: [
      ["nike", "나이키"],
      ["mercurial", "머큐리얼"],
      ["vapor", "베이퍼"],
  ...
  {
    id: "shoe-nike-mercurial-vapor-14-elite-ag",
    brand: "Nike",
    category: "shoe",
    laneKey: "nike_mercurial_vapor_14_elite_ag",
    modelName: "Nike Mercurial Vapor 14 Elite AG",
    aliases: ["Mercurial Vapor 14 Elite AG", "머큐리얼 베이퍼 14 엘리트 AG"],
    mustContain: [
      ["nike", "나이키"],
      ["mercurial", "머큐리얼"],
      ["vapor", "베이퍼"],
    ...
    mustNotContain: [
      ...SHOE_COMMON_NOISE,
      "superfly", "슈퍼플라이", "수퍼플라이",
      "pro", "프로", "fg", "tf", "풋살화", "ctr360", "마에스트리", "누우보", "nuovo",
    ],
    msrpKrw: 309000,
    released: 2021,
    defaultProductType: "sneaker",
  ...
  {
    id: "shoe-nike-mercurial-vapor-14-pro-tf",
    brand: "Nike",
    category: "shoe",
    laneKey: "nike_mercurial_vapor_14_pro_tf",
    modelName: "Nike Mercurial Vapor 14 Pro TF",
    aliases: ["Mercurial Vapor 14 Pro TF", "머큐리얼 베이퍼 14 프로 TF"],
    mustContain: [
      ["nike", "나이키"],
      ["mercurial", "머큐리얼"],
      ["vapor", "베이퍼"],
  ...
  },
  {
    ...
    mustNotContain: [
      ...
      "superfly", "슈퍼플라이", "수퍼플라이",
      "ctr360", "마에스트리",
      "베이퍼 1", "vapor 1", "베이퍼3", "베이퍼 3", "vapor3", "vapor 3",
  ...
  },
  {
    ...
    mustNotContain: [
      ...
      "리커브", "recouture",
      "꼼데가르송", "comme des",
      // Wave 856: special/collab axes should not refresh into plain broad samples.
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    mustContain: [
      ["y-3", "y3", "y 3", "와이쓰리", "와이 쓰리", "요지야마모토", "요지 야마모토", "요지야마모토 아디다스"],
      ["qasa", "콰사", "qasa high", "qasa elle", "콰사 하이"],
    ],
    mustNotContain: [
      ...SHOE_COMMON_NOISE,
    ],
  ...
  },
  {
    ...
    mustNotContain: [
      ...SHOE_COMMON_NOISE,
      ...SHOE_HIGH_END_NOISE,
      // Wave 810: anniversary / limited / designer variants do not share the plain Rhyton market.
      "100주년", "100 주년", "anniversary", "centennial",
      "한정", "한정판", "limited", "special edition",
      "꼼데", "꼼데가르송", "cdg", "comme des", "comme des garcons",
      "지드래곤", "지디", "gd", "g-dragon", "g dragon", "위버멘쉬", "ubermensch",
    ],
    msrpKrw: 1450000,
    released: 2018,
    defaultProductType: "sneaker",
  ...
  },
  {
    ...
    aliases: ["Prada America's Cup", "프라다 아메리카컵", "프라다 아메리카 컵", "프라다 아메리칸 컵"],
    mustContain: [
      ["prada", "프라다"],
      ["아메리카컵", "아메리카 컵", "아메리칸 컵", "america cup", "america's cup", "americas cup"],
      ["스니커즈", "sneaker", "신발", "shoe"],
    ],
    mustNotContain: [
      ...SHOE_COMMON_NOISE,
  ...
  {
    id: "shoe-hermes-oran-sandal",
    brand: "Hermes",
    category: "shoe",
    laneKey: "hermes_oran_sandal",
    modelName: "Hermes Oran Sandal (internal learning lane)",
    aliases: ["Hermes Oran", "에르메스 오란", "오란 샌들"],
    mustContain: [
      ["hermes", "에르메스"],
      ["오란", "oran"],
      ["샌들", "sandal"],
