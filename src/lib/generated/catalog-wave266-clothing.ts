...
const CLOTHING_COMMON_NOISE = [
  ...
  "삽니다", "구합니다", "구해요", "구함", "매입",
  "단추만", "지퍼만", "스트랩만", "박스만",
  // Wave 653 (2026-05-22): 가품 거래 표지 (pid 408135119 Arc'teryx Beta 130k outlier 발견).
  // 정상가 65~95만에 13만 박힘 + description "느낌 아시니깐 연락주세요" = 가품 시그널.
  "느낌 아시", "느낌아시", "느낌 알", "느낌알",
  "느낌 오시", "느낌오시", "느낌 모르",
  "느낌 좋", "느낌 좋아", "느낌 만점",  // 가품 마케팅
  // 광범위 가품 표지 (전체 fashion).
  "비매품", "샘플", "샘플품", "직원샘플",
];
