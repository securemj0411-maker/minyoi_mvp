...
export const CATALOG: Sku[] = [
  ...
  },
  {
    ...
    mustNotContain: ["1000xm", "xm5", "xm6", "ult900n", ...HEADPHONE_NOISE],
    msrpKrw: 89000,
    released: 2023,
  },
  {
    ...
    aliases: ["보스 QC 울트라", "Bose QC Ultra"],
    mustContain: [["보스", "bose"], ["qc 울트라", "qc ultra", "qcultra", "quietcomfort ultra"]],
    mustNotContain: ["이어 쿠션", "이어쿠션", "쿠션만", "케이스만", ...HEADPHONE_NOISE],
    msrpKrw: 499000,
    released: 2023,
  },
  {
