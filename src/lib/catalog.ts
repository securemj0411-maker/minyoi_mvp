...
const CORE_SMARTPHONE_CATALOG: Sku[] = [
  ...
  },
  {
    ...
    category: "smartphone",
    modelName: "iPhone 12",
    aliases: ["아이폰 12", "아이폰12", "iPhone 12"],
    mustContain: [["아이폰 12", "아이폰12", "iphone 12"]],
    mustNotContain: ["프로", "pro", "맥스", "max", "미니", "mini", ...PHONE_NOISE],
    msrpKrw: 1090000,
    released: 2020,
  },
  {
  ...
  },
  {
    ...
    category: "smartphone",
    modelName: "iPhone 13",
    aliases: ["아이폰 13", "아이폰13", "iPhone 13"],
    mustContain: [["아이폰 13", "아이폰13", "iphone 13"]],
    mustNotContain: ["프로", "pro", "맥스", "max", "미니", "mini", ...PHONE_NOISE],
    msrpKrw: 1090000,
    released: 2021,
  },
  {
    ...
    category: "smartphone",
    modelName: "iPhone 14",
    aliases: ["아이폰 14", "아이폰14", "iPhone 14"],
    mustContain: [["아이폰 14", "아이폰14", "iphone 14"]],
  ...
  },
  {
    ...
    category: "smartphone",
    modelName: "iPhone 15",
    aliases: ["아이폰 15", "아이폰15", "iPhone 15"],
    mustContain: [["아이폰 15", "아이폰15", "iphone 15"]],
    mustNotContain: ["프로", "pro", "맥스", "max", "플러스", "plus", ...PHONE_NOISE],
    msrpKrw: 1250000,
    released: 2023,
  },
  ...
  },
  {
    ...
    aliases: ["아이폰 15 프로", "아이폰15프로", "iPhone 15 Pro"],
    mustContain: [["아이폰 15 프로", "아이폰15프로", "iphone 15 pro"]],
    mustNotContain: ["맥스", "max", "프로맥스", "promax", "프로 맥스", "프맥", ...PHONE_NOISE],
    msrpKrw: 1550000,
    released: 2023,
  },
  {
    ...
    mustContain: [["아이폰 16", "아이폰16", "iphone 16"]],
    mustNotContain: ["프로", "pro", "맥스", "max", "플러스", "plus", "16e", ...PHONE_NOISE],
    msrpKrw: 1250000,
    released: 2024,
  },
  {
  ...
  },
  {
    ...
    aliases: ["갤럭시 S23", "갤럭시S23", "Galaxy S23"],
    mustContain: [["갤럭시 s23", "갤럭시s23", "galaxy s23", "s23"]],
    mustNotContain: ["울트라", "ultra", "플러스", "plus", "fe", "팬에디션", ...PHONE_NOISE],
    msrpKrw: 1150000,
    released: 2023,
  },
  {
    ...
    aliases: ["갤럭시 S24", "갤럭시S24", "Galaxy S24"],
    mustContain: [["갤럭시 s24", "갤럭시s24", "galaxy s24", "s24"]],
    mustNotContain: ["울트라", "ultra", "플러스", "plus", "fe", "팬에디션", ...PHONE_NOISE],
    msrpKrw: 1250000,
    released: 2024,
  },
