...
export const CATALOG: Sku[] = [
  ...
  },
  {
    ...
    brand: "Apple",
    category: "smartwatch",
    modelName: "Apple Watch SE 2nd gen (broad — 사이즈 미명시)",
    aliases: ["애플워치 SE 2세대", "애플워치 SE2", "Apple Watch SE 2"],
    mustContain: [["애플워치", "apple watch", "applewatch"], ["se2", "se 2", "se 2세대", "se 2nd"]],
    // Wave 793 (2026-05-27): 사이즈 narrow 분리 → broad 에서 차단.
    mustNotContain: ["se3", "se 3", "ultra", "40mm", "40 mm", "44mm", "44 mm"],
    msrpKrw: 359000,
    released: 2022,
    confusionNote: "SE 2세대 (2022). 외형 SE3와 거의 동일하지만 SE2는 4G LTE까지 (5G 없음). Nike 에디션 동일 HW, 시세 동일.",
  },
  // Wave 793 (2026-05-27): SE2 사이즈 narrow.
  {
    id: "applewatch-se2-40mm",
    brand: "Apple", category: "smartwatch",
    modelName: "Apple Watch SE 2 40mm",
    aliases: ["애플워치 SE2 40mm"],
    mustContain: [["애플워치", "apple watch", "applewatch"], ["se2", "se 2", "se 2세대"], ["40mm", "40 mm"]],
    mustNotContain: ["se3", "se 3", "ultra", "44mm", "44 mm"],
    msrpKrw: 329000, released: 2022,
  },
  {
    id: "applewatch-se2-44mm",
    brand: "Apple", category: "smartwatch",
    modelName: "Apple Watch SE 2 44mm",
    aliases: ["애플워치 SE2 44mm"],
    mustContain: [["애플워치", "apple watch", "applewatch"], ["se2", "se 2", "se 2세대"], ["44mm", "44 mm"]],
    mustNotContain: ["se3", "se 3", "ultra", "40mm", "40 mm"],
    msrpKrw: 359000, released: 2022,
  },
  {
    id: "applewatch-se3",
    brand: "Apple",
  ...
  // Wave 782 (2026-05-27): Seiko sub-line narrow — Grand Seiko 141건 (median ₩2.4M) drop 중.
  //   broad median ₩250K 와 시세 22배 차이.
  {
    id: "watch-seiko-grand-seiko",
    brand: "Seiko",
    category: "watch",
    laneKey: "watch_seiko_grand_seiko",
    modelName: "Grand Seiko",
    aliases: ["그랜드세이코", "Grand Seiko", "GS"],
    mustContain: [
      ["그랜드세이코", "그랜드 세이코", "grand seiko", "grandseiko"],
    ],
    mustNotContain: [...WATCH_NOISE,
      "킹세이코", "king seiko",
      "스트랩만", "밴드만", "케이스만", "베젤만",
      "롤렉스", "rolex", "오메가", "omega", "튜더", "tudor",
    ],
    msrpKrw: 4500000,
    released: 1960,
    confusionNote: "Grand Seiko (1960~). 명품 라인 — median ₩2.4M (DB). 일반 Seiko 와 시세 22배 차이.",
  },
  {
    id: "watch-seiko-alba",
    brand: "Seiko",
    category: "watch",
    laneKey: "watch_seiko_alba",
    modelName: "Seiko Alba",
    aliases: ["세이코 알바", "Seiko Alba", "Alba"],
    mustContain: [
      ["alba", "알바"],
      ["세이코", "seiko"],
    ],
    mustNotContain: [...WATCH_NOISE,
      "그랜드세이코", "grand seiko", "프로스펙스", "prospex", "프레사지", "presage", "astron", "credor", "크레도르",
      "스트랩만", "밴드만", "케이스만", "베젤만",
      "롤렉스", "rolex", "오메가", "omega",
    ],
    msrpKrw: 100000,
  ...
  // Wave 784 (2026-05-27): Seiko 나머지 sub-line narrow — 매물 5~28건이지만 일관성.
  {
    ...
    brand: "Seiko", category: "watch", laneKey: "watch_seiko_presage",
    modelName: "Seiko Presage",
    aliases: ["세이코 프레사지", "Seiko Presage"],
    mustContain: [["presage", "프레사지", "프리세이지", "프레사쥬"], ["세이코", "seiko"]],
    mustNotContain: [...WATCH_NOISE, "그랜드세이코", "grand seiko", "prospex", "프로스펙스", "alba", "알바", "astron", "credor", "크레도르",
      "스트랩만", "밴드만", "케이스만"],
    msrpKrw: 600000, released: 2011,
    confusionNote: "Seiko Presage (dress watch line). median ₩359K (DB).",
  },
  {
    id: "watch-seiko-credor",
    brand: "Seiko", category: "watch", laneKey: "watch_seiko_credor",
    modelName: "Seiko Credor (High-end)",
    aliases: ["세이코 크레도르", "Credor"],
    mustContain: [["credor", "크레도르"], ["세이코", "seiko"]],
    mustNotContain: [...WATCH_NOISE, "그랜드세이코", "grand seiko", "prospex", "alba", "astron", "presage",
      "스트랩만", "밴드만", "케이스만"],
    msrpKrw: 2000000, released: 1974,
    confusionNote: "Seiko Credor (High-end, 1974~). median ₩625K (DB).",
  },
  {
    id: "watch-seiko-premier",
    brand: "Seiko", category: "watch", laneKey: "watch_seiko_premier",
    modelName: "Seiko Premier",
    aliases: ["세이코 프리미어", "Seiko Premier"],
    mustContain: [["premier", "프리미어"], ["세이코", "seiko"]],
    mustNotContain: [...WATCH_NOISE, "그랜드세이코", "grand seiko", "prospex", "alba", "astron", "credor", "presage",
      "스트랩만", "밴드만", "케이스만"],
    msrpKrw: 500000, released: 2007,
    confusionNote: "Seiko Premier. median ₩290K (DB).",
  },
  {
    id: "watch-seiko-brightz",
    brand: "Seiko", category: "watch", laneKey: "watch_seiko_brightz",
    modelName: "Seiko Brightz",
    aliases: ["세이코 브라이츠", "Seiko Brightz"],
    mustContain: [["brightz", "브라이츠"], ["세이코", "seiko"]],
    mustNotContain: [...WATCH_NOISE, "그랜드세이코", "grand seiko", "prospex", "alba", "astron", "credor", "presage",
      "스트랩만", "밴드만", "케이스만"],
    msrpKrw: 800000, released: 2002,
    confusionNote: "Seiko Brightz (titanium 라인). median ₩650K (DB).",
  },
  {
    id: "watch-seiko-astron",
    brand: "Seiko", category: "watch", laneKey: "watch_seiko_astron",
    modelName: "Seiko Astron (GPS Solar)",
    aliases: ["세이코 아스트론", "Seiko Astron"],
    mustContain: [["astron", "아스트론"], ["세이코", "seiko"]],
    mustNotContain: [...WATCH_NOISE, "그랜드세이코", "grand seiko", "prospex", "alba", "credor", "presage",
      "스트랩만", "밴드만", "케이스만"],
    msrpKrw: 2000000, released: 2012,
    confusionNote: "Seiko Astron (GPS solar, 2012~). median ₩1.5M (DB).",
  },
  {
