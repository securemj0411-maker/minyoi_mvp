...
export const CATALOG: Sku[] = [
  ...
  },
  {
    ...
    aliases: ["Acne Apparel", "아크네 의류", "아크네 코트"],
    mustContain: [["acne", "아크네"], ["반팔", "티셔츠", "tee ", "후드", "hoodie", "맨투맨", "셔츠", "shirt", "자켓", "jacket", "코트", "coat", "치노", "chino", "팬츠", "pants", "데님", "denim", "스웨터", "knit"]],
  ...
  },
  {
    ...
    modelName: "Nike Blazer (Mid 77 / SB / Vintage broad)",
    aliases: ["Nike Blazer", "나이키 블레이저", "Blazer Mid"],
