...
const LATEST_PARSER_VERSION_BY_CATEGORY: Partial<Record<NonNullable<Sku["category"]>, string>> = {
  ...
  // Wave 700 (2026-05-23): shoe v33 — Crocs collab (Salehe/BAPE/Balenciaga) + Crocs Boots/Slipper/LightRide broad + Puma 4 broad (Speedcat/Palermo/Suede/Clyde).
  shoe: "wave92-shoe-v33",
