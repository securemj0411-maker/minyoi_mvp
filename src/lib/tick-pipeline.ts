...
//   88초 spike + 10분 timeout 누적. 1h cooldown 2h 로 늘림 (사용자 보수적 선택 — 4h 너무 길까봐).
//   query crawl 빈도 영향 미미 (2h 1회 재평가 충분), housekeeper stale 차단.
const QUERY_CADENCE_EVAL_COOLDOWN_MS = 2 * 60 * 60_000; // 2시간
