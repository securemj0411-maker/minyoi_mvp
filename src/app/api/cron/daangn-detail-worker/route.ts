...
async function handleDaangnDetailWorker(req: NextRequest) {
  ...
  const limit = envInt("DAANGN_DETAIL_WORKER_LIMIT", 100, 1, 200);
  const budgetMs = envInt("DAANGN_DETAIL_WORKER_BUDGET_MS", 115_000, 5_000, 260_000);
  const delayMs = envInt("DAANGN_DETAIL_WORKER_DELAY_MS", 450, 0, 10_000);
