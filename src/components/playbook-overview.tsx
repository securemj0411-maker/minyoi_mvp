...
const SECTIONS: Section[] = [
  ...
  },
  {
    id: "vs-search",
    number: 8,
    title: "미뇨이 추천 vs 직접 검색",
    short: "직접 검색 비교",
    blocks: [
      {
        kind: "p",
        text: "번개장터 직접 검색하면 모든 매물이 다 보여요. 부품용 / 고장 / 케이스만 / 사기 의심 매물까지 사용자가 직접 골라야 합니다.",
      },
      {
        kind: "p",
        text: "미뇨이 추천 매물은:",
      },
      {
        ...
        items: [
          "모델 자동 분류 (정확도 우선)",
          "부품용 / 고장 / 케이스만 / 매입 광고 자동 제거",
          "시세 비교 + 판매자 등급 + 호가 분포 한 화면",
          "왜 이 매물이 좋은가 이유 표시",
        ],
      },
      {
        kind: "callout",
        tone: "highlight",
        text: "같은 30분을 써도 미뇨이가 잘못된 매물에 시간 낭비를 안 하게 해줍니다. 단 미뇨이는 모든 매물을 보여주진 않아요 — 확실한 것만 추천하는 방식입니다.",
      },
    ],
  },
  {
