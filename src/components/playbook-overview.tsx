...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    blocks: [
      {
        kind: "intro",
        text: "차익잡이가 자동 분류하는 정확도는 종류마다 달라요.",
      },
      {
        kind: "list",
        items: [
  ...
  },
  {
    ...
    blocks: [
      {
        kind: "intro",
        text: "차익잡이는 번개장터·중고나라·당근의 공개 매물을 기반으로 추천합니다. 같은 데이터를 직접 검색할 수도 있고, 미리 분류·검증된 결과를 받을 수도 있습니다. 차이는 결정까지 드는 시간입니다.",
      },
      {
        kind: "p",
      ...
      {
        kind: "p",
        text: "차익잡이는 모든 매물을 보여주지 않습니다. 정확도 우선 정책에 따라 확신이 서지 않는 매물은 \"안 보여줌\"으로 처리합니다. 보여주는 추천에 대한 신뢰를 우선합니다.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        kind: "intro",
        text: "차익잡이가 자동 거른 다음에도 본인이 직접 한 번 더 확인:",
      },
      {
        kind: "checklist",
        items: [
      ...
      },
      {
        kind: "callout",
        tone: "warn",
        text: "⚠️ 차익잡이는 추천 도구이지 사기 탐지기는 아닙니다. 마지막 확인은 본인 책임입니다.",
      },
    ],
  },
  {
    ...
    <div ref={containerRef} className="space-y-5">
      <div className="rounded-[24px] border border-[#e2d9cb] bg-[#fffaf6] p-4 shadow-[0_18px_36px_rgba(34,49,39,0.06)] dark:border-zinc-800 dark:bg-zinc-900 sm:p-6 lg:rounded-[28px]">
        ...
        <p className="mt-2 max-w-2xl text-xs font-semibold leading-6 text-[#687366] dark:text-zinc-400 sm:text-sm">
          차익잡이를 활용해 같은 매물도 다르게 보고, 시간 게임에서 우위를 가지는 법.
