...
export default function PaymentTrustCard() {
  return (
    <details className="group rounded-[14px] border border-zinc-200 bg-white/80 ring-1 ring-zinc-100 dark:border-zinc-800 dark:bg-zinc-950/70 dark:ring-white/10 [&_summary::-webkit-details-marker]:hidden">
      <summary className="flex cursor-pointer list-none items-center justify-between gap-3 px-3.5 py-3">
        <span className="min-w-0">
          <span className="block text-[12px] font-black text-zinc-700 dark:text-zinc-200">
            사업자 정보 확인
          </span>
          <span className="mt-0.5 block break-keep text-[10.5px] font-bold text-zinc-400">
            예금주·상호 일치, 환불정책 확인
          </span>
        </span>
        <span
          aria-hidden="true"
          className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-zinc-100 text-[16px] font-black text-zinc-500 transition group-open:rotate-180 dark:bg-zinc-900 dark:text-zinc-300"
        >
          ⌄
        </span>
      </summary>
