...
export default function CreditIcon({ size = 24, className = "" }: CreditIconProps) {
  return (
    ...
    >
      <defs>
        <linearGradient id="credit-coin-face" x1="18" y1="10" x2="47" y2="56" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#d3aa3e" />
          <stop offset="0.48" stopColor="#bf9430" />
          <stop offset="1" stopColor="#9c7621" />
        </linearGradient>
        <linearGradient id="credit-coin-rim" x1="13" y1="7" x2="52" y2="59" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#b88b28" />
          <stop offset="0.5" stopColor="#8f6a1f" />
          <stop offset="1" stopColor="#6f5218" />
        </linearGradient>
        <radialGradient id="credit-coin-shine" cx="0" cy="0" r="1" gradientTransform="translate(24 18) rotate(55) scale(35 31)" gradientUnits="userSpaceOnUse">
      ...
      <circle cx="32" cy="32" r="30" fill="url(#credit-coin-rim)" />
      <circle cx="32" cy="32" r="26.5" fill="url(#credit-coin-face)" />
      <circle cx="32" cy="32" r="23.5" stroke="#7f5d1b" strokeOpacity="0.55" strokeWidth="1.2" />
      <circle cx="32" cy="32" r="26.5" fill="url(#credit-coin-shine)" />
