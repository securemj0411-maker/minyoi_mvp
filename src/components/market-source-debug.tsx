...
function MarketSourceDebugSkeleton() {
  ...
  return (
    <div className="animate-pulse space-y-3" aria-busy="true">
      <div className="rounded-xl border-2 border-blue-200 bg-blue-50 p-3 dark:border-blue-900/50 dark:bg-blue-950/20">
        <div className="flex gap-3">
          <div className="h-24 w-24 shrink-0 rounded-lg bg-blue-100 dark:bg-blue-900/50" />
          <div className="min-w-0 flex-1 space-y-2">
            {line("h-3 w-32 bg-blue-100 dark:bg-blue-900/50")}
            {line("h-4 w-4/5")}
            {line("h-5 w-56")}
            {line("h-3 w-44")}
          ...
          >
            ...
            <div className="flex-1 space-y-3 overflow-y-auto px-4 py-3 text-xs">
              ...
              {data && (
                <>
                  ...
                  <div className="rounded-xl border-2 border-blue-400 bg-blue-50 p-3 dark:border-blue-700 dark:bg-blue-950/30">
                    <div className="flex gap-3">
                      {data.ourListing.thumbnailUrl && (
                        <Image
                          ...
                          height={96}
                          unoptimized
                          className="h-24 w-24 shrink-0 rounded-lg object-cover ring-2 ring-blue-300 dark:ring-blue-700"
                        />
                      )}
                      <div className="min-w-0 flex-1">
                        ...
                        <a
                          ...
                          className="mt-1 inline-flex items-center gap-1 text-[11px] font-bold text-blue-700 hover:underline dark:text-blue-400"
                        >
                  ...
                  <div>
                    ...
                    {data.ourListing.productType && data.ourListing.productType !== "type_unknown" && (
                      <div className="mb-2 rounded-md bg-blue-50 px-2 py-1 text-[11px] text-blue-700 ring-1 ring-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:ring-blue-700">
                          ...
                          <Fragment key={c.pid}>
                            {showHeader && (
                              <div className={`mb-1 mt-2 px-1 text-[10px] font-bold uppercase tracking-wide ${
                                dist === 0 ? "text-blue-600 dark:text-blue-400"
            ...
            <div className="border-t border-zinc-200 bg-zinc-50 px-4 py-3 dark:border-zinc-800 dark:bg-zinc-900/60">
              <div className="mb-1.5 flex items-baseline justify-between text-[10px] font-bold">
                ...
                {noteSaved && <span className="text-blue-600 dark:text-blue-400">✓ 저장됨</span>}
              </div>
              <textarea
                value={note}
                ...
                className="w-full resize-y rounded-md border border-zinc-300 bg-white px-3 py-2 text-xs leading-5 text-zinc-800 outline-none transition placeholder:text-zinc-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 disabled:opacity-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:focus:border-blue-400 dark:focus:ring-blue-900"
              />
              <div className="mt-1.5 flex items-center justify-between">
                ...
                <button
                  ...
                  className="rounded-md bg-blue-700 px-4 py-1.5 text-[11px] font-black text-white hover:bg-blue-800 disabled:cursor-not-allowed disabled:opacity-40 dark:bg-blue-600 dark:hover:bg-blue-700"
                >
