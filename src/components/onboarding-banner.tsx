...
export default function OnboardingBanner({ onStart }: { onStart?: () => void }) {
  ...
  return (
    <div className="relative mb-4 overflow-hidden rounded-2xl border border-blue-200 bg-gradient-to-br from-blue-50 to-[#fffbf4] p-4 shadow-[0_12px_28px_rgba(63,99,67,0.08)] dark:border-blue-800 dark:from-blue-950/30 dark:to-zinc-900">
      <div className="flex items-start gap-3">
        <span className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-blue-500 text-white shadow-md">
