          ...
          <div className="mt-5 grid gap-2">
            ...
            {isPaywall ? (
              <button
                ...
                title={kakaoShareCooldownHours > 0 ? `${kakaoShareCooldownHours}시간 후 다시 받을 수 있어요` : (kakaoShareReady ? "카톡으로 공유하고 크레딧 2개 받기" : "카카오 공유 로딩 중...")}
              ...
              >
                <div className="flex min-w-0 items-center gap-2.5">
                  ...
                  <div className="min-w-0">
                    <div className={`text-sm font-bold ${kakaoShareReady && kakaoShareCooldownHours === 0 ? "text-[#3b1e1e]" : "text-[#3b1e1e]/80"}`}>
                      {kakaoShareCooldownHours > 0 ? "오늘은 이미 받았어요" : kakaoShareLoading ? "공유 처리 중..." : "카톡 공유하고 무료로 2개 받기"}
                    </div>
                ...
                <span className={`shrink-0 rounded-full px-2 py-0.5 text-[10px] font-bold ${
                  ...
                  {kakaoShareCooldownHours > 0 ? "내일" : "+2 크레딧"}
                </span>
              </button>
            ) : null}
